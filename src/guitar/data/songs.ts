...
export const SONGS: Song[] = [
  ...
  },
  {
    ...
    chords: [
      ...
      { chord: "Em", lyrics: "But you see", beats: 4 },
      { chord: "C", lyrics: "it's not me", beats: 4 },
      { chord: "G", lyrics: "It's not my", beats: 4 },
      { chord: "D", lyrics: "family", beats: 4 },
      { chord: "Em", lyrics: "In your head", beats: 4 },
      { chord: "C", lyrics: "in your head", beats: 4 },
      { chord: "G", lyrics: "Zombie,", beats: 4 },
      { chord: "D", lyrics: "zombie, zombie", beats: 4 },
    ],
  },
];
