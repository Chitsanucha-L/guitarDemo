...
export const SONGS: Song[] = [
  {
    ...
    key: "Em",
    chords: [
      { chord: "Em", lyrics: "Another head", beats: 4 },
      { chord: "C", lyrics: "hangs lowly,", beats: 4 },
      { chord: "G", lyrics: "Child is slowly", beats: 4 },
      { chord: "D", lyrics: "taken.", beats: 4 },
      { chord: "Em", lyrics: "And the violence", beats: 4 },
      { chord: "C", lyrics: "caused such silence,", beats: 4 },
      { chord: "G", lyrics: "Who are we", beats: 4 },
      { chord: "D", lyrics: "mistaken?", beats: 4 },
      { chord: "Em", lyrics: "But you see, it's not me, it's not", beats: 8 },
      { chord: "C", lyrics: "my family.", beats: 4 },
      { chord: "G", lyrics: "In your head, in your head", beats: 4 },
      { chord: "D", lyrics: "they are fighting", beats: 4 },
      { chord: "Em", lyrics: "With their tanks and their bombs", beats: 4 },
      { chord: "C", lyrics: "And their bombs and their guns", beats: 4 },
      { chord: "G", lyrics: "In your head, in your head", beats: 4 },
      { chord: "D", lyrics: "they are crying", beats: 4 },
    ],
  },
  {
    id: "stand-by-me",
