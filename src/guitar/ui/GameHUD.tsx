    ...
    <div className="absolute top-0 left-0 w-full min-h-[8rem] pointer-events-none z-50">
      ...
      <div className="absolute top-2 lg:top-20 left-3 lg:left-6">
        <div className="bg-gray-900/60 backdrop-blur-md rounded-xl px-3 lg:px-5 py-1.5 lg:py-3 border border-blue-500/30 shadow-lg shadow-blue-500/5">
          ...
          <div className="text-xl lg:text-4xl font-bold text-white tabular-nums">{score}</div>
          {poolSize > 0 && (
            <div className="text-[10px] lg:text-xs text-cyan-400/90 mt-0.5 tabular-nums">
      ...
      <div className="absolute top-2 lg:top-16 left-1/2 transform -translate-x-1/2">
        <div className="relative">
          ...
          <div className="relative bg-gray-900/80 backdrop-blur-md rounded-2xl px-3 lg:px-14 py-1.5 lg:py-5 border-2 border-yellow-500/40 shadow-2xl shadow-yellow-500/10">
            <div className="text-[8px] lg:text-xs text-gray-500 font-medium text-center uppercase tracking-widest mb-0.5 lg:mb-1">{t("game.playThisChord")}</div>
            <div className="text-2xl lg:text-4xl xl:text-6xl font-black text-yellow-400 tracking-wider drop-shadow-lg text-center">
              {chordName || "---"}
            </div>
            <div className="flex justify-center flex-wrap gap-1 mt-0.5 lg:mt-2">
              <span
                className={`text-[8px] lg:text-[10px] font-bold px-2 py-0.5 rounded-full ${
                  isPractice
              ...
              {difficultyLabel && (
                <span className="text-[8px] lg:text-[10px] font-bold px-2 py-0.5 rounded-full bg-cyan-600/50 text-cyan-100 border border-cyan-400/30">
                  {difficultyLabel}
                </span>
              )}
            </div>
