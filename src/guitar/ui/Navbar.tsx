...
export default function Navbar({
  ...
  const navClassName =
    variant === "home"
      ? "fixed top-0 left-0 w-full bg-gray-800 text-white px-3 py-2 lg:p-4 flex justify-between items-center shadow-md z-10"
      : "fixed top-0 left-0 w-full bg-gray-900/95 backdrop-blur-md text-white px-3 py-2 lg:p-4 flex justify-between items-center shadow-lg z-10 border-b border-gray-700/50";
